Feature: Creating comments
  In order to update a tickets's progress
  As a user 
  ...
  Scenario: Changing a ticket's state
    ...
    And I press "Create Comment"
    Then I should see "Comment has been created."
    And I should see "Open" within the tag ".state" of "#ticket"
  ...
  Scenario: Adding a tag to a ticket
    When I follow "Change a ticket's state"
    Then I should not see "bug" within the tag "#tags" of "#ticket"
    And I fill in "Text" with "Adding the bug tag"
    And I fill in "Tags" with "bug"
    And I press "Create Comment"
    Then I should see "Comment has been created."
    And I should see "bug" within the tag "#tags" of "#ticket"